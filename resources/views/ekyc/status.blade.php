                ...
                <div class="p-8 text-gray-800 text-center">
                        ...
                        <div class="bg-red-100 border border-red-400 text-red-700 px-6 py-4 rounded-lg mb-4">
                            ...
                            <div class="flex justify-center gap-4 mt-6">
                                <a href="{{ route('ekyc.step1') }}"
                                    class="inline-flex items-center px-5 py-2 bg-red-600 border border-transparent rounded-md
                                    font-semibold text-xs text-white uppercase tracking-widest hover:bg-red-700
                                    focus:bg-red-700 active:bg-red-800 focus:outline-none focus:ring-2 focus:ring-indigo-500
                    ...
                    <div class="flex justify-center mt-6">
                        <a href="{{ route('dashboard') }}"
                            class="inline-flex items-center px-5 py-2 bg-green-600 border border-transparent rounded-md
                            font-semibold text-xs text-white uppercase tracking-widest hover:bg-green-700
                            focus:bg-green-700 active:bg-green-800 focus:outline-none focus:ring-2 focus:ring-green-500
                            focus:ring-offset-2 transition ease-in-out duration-150">
                            Dashboard
                        </a>
                    </div>
