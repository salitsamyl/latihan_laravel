...
<body class="bg-white text-gray-800">
    ...
    <header class="w-full py-4 bg-blue-900 shadow-sm fixed top-0 left-0 z-50">
        <div class="max-w-7xl mx-auto flex justify-between items-center px-4">
            ...
            <nav class="hidden md:flex gap-8 text-white font-medium">
                ...
                <a href="{{ $nav->url }}" class="hover:text-blue-100">
                    {{ $nav->label }}  
                </a>  
                @endforeach  
            </nav>
            ...
            <div class="flex gap-3">
                ...
                <nav class="flex items-center justify-end gap-4">
                    ...
                    <a
                        href="{{ route('register') }}"
                        class="px-4 py-2 bg-white text-blue-900 rounded-lg font-medium hover:bg-blue-100"
                    >
                        Register
                    </a>
                    @endif
        ...
        <div class="max-w-7xl mx-auto grid md:grid-cols-2 gap-10 px-4 items-center">
            ...
            <div>
                ...
                <div class="flex gap-4">
                    ...
                    <a
                        href="{{ route('register') }}"
                        class="px-6 py-3 bg-blue-900 text-white rounded-lg font-semibold text-lg hover:bg-blue-700">
                        Daftar Sekarang
                    </a>
                    @endif

                    <a href="#program" class="px-6 py-3 border border-blue-900 text-blue-600 rounded-lg font-semibold text-lg hover:bg-blue-50">
                        Lihat Program
                    </a>
                </div>
            </div>
    ...
    <div class="grid md:grid-cols-3 gap-8">
        @foreach($programs as $program)
            <div class="bg-gray-50 p-8 rounded-xl shadow-sm hover:shadow-lg transition 
                ...
                <div class="mb-6 h-20 w-20 flex items-center justify-center">
                    @if($program->image)
                        <img src="{{ asset('storage/' . $program->image) }}"
                             alt="{{ $program->title }}"
                             class="max-h-20 max-w-20 w-auto h-auto object-contain rounded-lg 
                                    shadow-md hover:scale-110 transition-transform duration-300">
                    @else
                        <div class="bg-gray-200 border-2 border-dashed rounded-xl w-20 h-20"></div>
                    @endif
                </div>
                ...
                <p class="text-gray-600 text leading-relaxed flex-grow">
                    {{ $program->description }}
                </p>
            </div>
        @endforeach
    ...
    <section id="tentang" class="py-20 bg-gray-50">
        <div class="max-w-6xl mx-auto px-4 grid md:grid-cols-2 gap-10 items-center">
            ...
            <div>
                <img src="{{ asset('uploads/landing/mhs-lp3i.jpg') }}"
    ...
    <footer id="kontak" class="bg-blue-900 text-white py-10">
        <div class="max-w-7xl mx-auto px-4 grid md:grid-cols-3 gap-10">
            ...
            <div>
                ...
                <ul class="space-y-2 text-white-100">
